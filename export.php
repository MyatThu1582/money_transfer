      ...
      <h3 class="mb-0">
        ...
        <?php 
            if($report == 'cash_in_percentage'){
                ...
                echo $payment_name . "ငွေထုတ်ဝန်ဆောင်ခ" . " From " . date('d-m-Y', strtotime($start_date)) . " To " . date('d-m-Y', strtotime($end_date));
            } elseif($report == 'total_cash_in'){
                echo $payment_name . "ငွေဝင်စာရင်း" . " From " . date('d-m-Y', strtotime($start_date)) . " To " . date('d-m-Y', strtotime($end_date));
            } elseif($report == 'total_cash_out'){
                echo $payment_name . "ထွက်ငွေစာရင်း" . " From " . date('d-m-Y', strtotime($start_date)) . " To " . date('d-m-Y', strtotime($end_date));
            } elseif($report == 'total_cash_in_out'){
                echo $payment_name . "ငွေအဝင်/အထွက်စာရင်း" . " From " . date('d-m-Y', strtotime($start_date)) . " To " . date('d-m-Y', strtotime($end_date));
            } elseif($report == 'balance'){
                echo $payment_name . "လက်ကျန်ငွေစာရင်း" . " From " . date('d-m-Y', strtotime($start_date)) . " To " . date('d-m-Y', strtotime($end_date));
            }
        ?>
      </h3>
    </div>
  ...
  <div class="row">
    ...
    // Cash In Percsntage Report
      if($report == 'cash_in_percentage'){
        ...
        header("Content-Disposition: attachment; filename=cash_in_percentage.xls");
    ...
    <div class="">
        ...
        <table border="1">
          <thead class="table-light">
            <tr>
                <th class="text-center" style="width: 522px;">စုစုပေါင်းငွေသွင်းဝန်ဆောင်ခ</th>
    ...
    // Cash Out Percentage Report
        ...
        header("Content-Type: application/vnd.ms-excel");
        header("Content-Disposition: attachment; filename=cash_out_percentage.xls");
    ...
    // Total Cash In Amount Report
        ...
        header("Content-Type: application/vnd.ms-excel");
        header("Content-Disposition: attachment; filename=total_cash_in.xls");
    ...
    // Total Cash Out Amount Report
        ...
        header("Content-Type: application/vnd.ms-excel");
        header("Content-Disposition: attachment; filename=total_cash_out.xls");
    ...
    <div class="table-responsive  mb-3">
      ...
      // Cash In && Out Amount Report
        ...
        header("Content-Type: application/vnd.ms-excel");
        header("Content-Disposition: attachment; filename=total_cash_in_out.xls");
